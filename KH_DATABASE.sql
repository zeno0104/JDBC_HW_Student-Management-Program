------------------------------------------------------
-- KH_UNIVERSITY FULL CLEAN BUILD (Oracle)
-- DROP → CREATE → INSERT → COMMIT
-- 에러 없는 완전 정리본 ✅
------------------------------------------------------
...
CREATE TABLE KH_PROFESSOR (
    ...
    POSITION    NVARCHAR2(20)
                 CHECK (POSITION IN ('교수', '부교수', '조교수', '전임교수')),
    EMAIL       VARCHAR2(50),
    PHONE       VARCHAR2(20),
...
INSERT INTO KH_PROFESSOR VALUES ('PR104', '박하린', 'CS', '교수', 'harin@univ.ac.kr', '010-4444-4444', DEFAULT);
